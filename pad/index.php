...
function confirmDocumentReceipt(doc_id,received_by,office_division) {
  ...
  Swal.fire({
    ...
    confirmButtonColor: "#28a745", // Green for confirmation
    cancelButtonColor: "#6c757d", // Grey for cancel
    confirmButtonText: "Yes, I have received it"
  }).then((result) => {
    if (result.isConfirmed) {
      // **Perform the action for confirming receipt here**
    ...
    // You could optionally add an 'else' block here if the user cancels
  });
}
